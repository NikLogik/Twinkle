...
import ru.nachos.core.replanning.handlers.AgentInsideFirefrontHandlerImpl;
...
public class EventManagerImpl implements EventManager {
    ...
    public EventManagerImpl() {
        ...
        handlerMap.put(AgentInsideFirefrontEvent.class, new AgentInsideFirefrontHandlerImpl());
    }
    ...
    private boolean callHandler(Class<? extends Event> clazz, Event event, EventHandler handler){
        if (clazz == AgentsChangePolygonEvent.class){
            ...
            return true;
        } else if (clazz == AgentInsideFirefrontEvent.class){
            ((AgentInsideFirefrontHandler)handler).handleEvent((AgentInsideFirefrontEvent)event);
        }
        return false;
    }
